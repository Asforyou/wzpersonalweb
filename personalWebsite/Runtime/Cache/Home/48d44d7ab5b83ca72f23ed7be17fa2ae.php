    ...
    <div class="other">
        ...
        <div class="center">
           <div class="content">
                <!-- 最新发布 -->
                <div class="newPost">
                    <h3><span>常用资料工具下载</span></h3>
                        <!-- <span class="tipNum">下载次数</span> -->
                        <?php if(is_array($download)): foreach($download as $key=>$download): ?><dl class="downloadItem">
                                <dd>
                                    <span class="downloadEle"><a data-id="<?php echo ($download["d_id"]); ?>" download href="<?php echo ($download["d_href"]); ?>"><?php echo ($download["d_name"]); ?></a></span>
                                    <span class="downloadNum"><i class="fa fa-download" aria-hidden="true"></i><em class="dNum">(<?php echo ($download["d_num"]); ?>)</em></span>
                                </dd>
